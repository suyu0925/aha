    ...
    private class ExListAdapter extends BaseExpandableListAdapter implements OnLongClickListener {
        ...
        public View getChildView(int groupPosition, int childPosition, boolean isLastChild,
            ...
            if (groupPosition < children.size()) {// 如果groupPosition的序号能从children列表中获得一个children对象
                ...
                msgCountView.setText(String.format(msgCountStr,
                        mService.getMessagesCountById(person.personId)));
                    ...
                    btn_ok.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            if (!finishedSendFile) {// 如果本次文件已经接收过了则不再打开文件夹选择器
                                Intent intent = new Intent(FlyPigeonMainActivity.this,
                                        MyFileManager.class);
    ...
    private class MyBroadcastRecv extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            if (intent.getAction().equals(Constant.updateMyInformationAction)) {
                ...
                Toast.makeText(FlyPigeonMainActivity.this, intent.getExtras().getString("msg"),
                        Toast.LENGTH_SHORT).show();
                ...
                if (!isPaused) {
                    ...
                    String title = String
                            .format(getString(R.string.talk_with), psn.personNickeName);
                    AlertDialog.Builder builder = new AlertDialog.Builder(
                            FlyPigeonMainActivity.this);
                    builder.setTitle(me.personNickeName);
                    builder.setMessage(title);
                    builder.setIcon(me.personHeadIconId);
                ...
                Toast.makeText(FlyPigeonMainActivity.this, getString(R.string.refuse_receive_file),
                        Toast.LENGTH_SHORT).show();
