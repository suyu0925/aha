 ...
 * 
 * @author ccf 2012/2/23
 */
public class MyFeiGeFileActivity extends MyFeiGeBaseActivity implements OnItemClickListener,
        OnClickListener {
    ...
    private void refreshListItems(String path) {
        ...
        SimpleAdapter listAdapter = new SimpleAdapter(this, adapterList, R.layout.file_item,
                ...
                new int[] {
                        R.id.file_name, R.id.file_path, R.id.file_img
                });
